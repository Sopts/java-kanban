...
public class Main {
    public static void main(String[] args) {
        ...
        Epic epic1 = new Epic("Epic1", "Description",
                LocalDateTime.now().plusHours(20), Duration.ofHours(1));
        manager.createEpic(epic1);
        Subtask subtask1 = new Subtask("Subtask1", "Description",
                LocalDateTime.now().plusHours(30), Duration.ofHours(1), epic1.getId());
        manager.createSubtask(subtask1);
        Subtask subtask2 = new Subtask("Subtask2", "Description",
                LocalDateTime.now().plusHours(34), Duration.ofHours(3), epic1.getId());
        manager.createSubtask(subtask2);
        Subtask subtask3 = new Subtask("Subtask3", "Description",
                LocalDateTime.now().plusHours(40), Duration.ofHours(4), epic1.getId());
